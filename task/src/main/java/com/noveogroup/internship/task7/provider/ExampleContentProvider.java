...
public class ExampleContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String orderBy) {
        int uriType = ContentContract.uriMatcher.match(uri);
        String tableName = ContentContract.getTableName(uriType);
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        if (TextUtils.equals(tableName, ContentContract.Toys.TABLE_NAME)) {
            return Uri.parse(ContentContract.Toys.TABLE_URI + "/" + id);
        } else {
            return null;
        }
    }
